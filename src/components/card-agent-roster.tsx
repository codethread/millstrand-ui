  ...
  return (
    <div className="shrink-0 bg-muted/30">
      <div className="flex items-center justify-between gap-2 px-3 py-2">
        <span className="text-[10px] font-medium text-muted-foreground">Agents on this card</span>
        {historyCount > 0 && (
          <Button
            variant="ghost"
            size="sm"
      ...
      <div className="flex items-center justify-between gap-2 border-t border-border px-3 py-2 text-[9px] text-muted-foreground">
        <p>
          {selected.relation === 'target'
            ? 'Tracked run linked to this card or its tasks · log covers the whole session'
